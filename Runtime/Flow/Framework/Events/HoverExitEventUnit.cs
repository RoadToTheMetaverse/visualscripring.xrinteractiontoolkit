...
{
    public abstract class HoverExitEventUnit : GameObjectEventUnit<HoverExitEventArgs>
    {
        ...
        protected override void AssignArguments(Unity.VisualScripting.Flow flow, HoverExitEventArgs args)
        {
