...
{
    public abstract class SelectExitEventUnit : GameObjectEventUnit<SelectExitEventArgs>
    {
        ...
        protected override void AssignArguments(Unity.VisualScripting.Flow flow, SelectExitEventArgs args)
        {
