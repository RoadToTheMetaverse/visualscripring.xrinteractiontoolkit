...
{
    public abstract class ActivateEventUnit : GameObjectEventUnit<ActivateEventArgs>
    {
        ...
        protected override void AssignArguments(Unity.VisualScripting.Flow flow, ActivateEventArgs args)
        {
